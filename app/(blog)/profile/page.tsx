      ...
      <div className="mx-auto grid w-full max-w-5xl gap-6 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_18rem] lg:px-8">
        <section className="rounded-2xl border-2 border-[#1E293B] bg-white p-5 shadow-pop-sm sm:p-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-sm leading-6 text-[#64748B]">
              Chỉnh thông tin mà cộng đồng nhìn thấy khi bạn đặt câu hỏi hoặc
              viết phản hồi.
            </p>
          </div>
          <div className="mt-8 border-t-2 border-[#E2E8F0] pt-7">
        ...
        <aside className="h-fit rounded-2xl border-2 border-[#1E293B] bg-[#EDE9FE] p-5 shadow-pop-sm">
          ...
          <dl className="mt-5 space-y-5 text-sm">
            <div>
              <dt className="flex items-center gap-2 font-bold text-[#64748B]">
                <Mail className="h-4 w-4" />
                Email
              </dt>
              <dd className="mt-1 break-all font-semibold text-[#1E293B]">
                {profile.email}
              </dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="mt-1 font-semibold text-[#1E293B]">{joinedAt}</dd>
            </div>
          </dl>
          <p className="mt-6 rounded-xl border border-[#C4B5FD] bg-white/70 p-3 text-xs leading-5 text-[#475569]">
